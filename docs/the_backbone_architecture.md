# The backbone architecture {#backbone}
...
<p align="justify"> The <a href="https://arxiv.org/abs/1807.10165"> Unet++ </a> was chosen as the backbone architecture of the <b>first version</b> of our data-driven model to predict fire danger (burned area maps) based on future climate change projections.</p>
